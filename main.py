...
app = FastAPI(title="GSA API", version="1.0.0")
...
class UserInput(BaseModel):
    ...
    secret_key: str = Field(..., min_length=1, description="Secret key from .env")
...
def submit_input(payload: UserInput) -> ApiResponse:
